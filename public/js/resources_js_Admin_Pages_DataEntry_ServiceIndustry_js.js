"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Admin_Pages_DataEntry_ServiceIndustry_js"],{

/***/ "./resources/js/Admin/Pages/DataEntry/ServiceIndustry.js":
/*!***************************************************************!*\
  !*** ./resources/js/Admin/Pages/DataEntry/ServiceIndustry.js ***!
  \***************************************************************/
...
function Industry() {
  ...
  var HandleAdd = function HandleAdd(e) {
    e.preventDefault();
    setadding(true);
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.post('/industry/store', {
      name: NewCat
    }).then(function (res) {
  ...
  var HandleDelete = function HandleDelete(e, itemId) {
    e.preventDefault();
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.delete("/industry/delete/".concat(itemId)).then(function (res) {
      if (res.status == 200) {
  ...
  var sendUpdateRequest = function sendUpdateRequest(e) {
    e.preventDefault();
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.put("industry/update/".concat(editId), {
      name: edit_cat
    }).then(function (res) {
      if (res.status == 200) {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("h4", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("h5", {
              children: "Service Industry Type"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Industry);
