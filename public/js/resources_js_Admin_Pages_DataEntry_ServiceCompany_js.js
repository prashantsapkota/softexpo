"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Admin_Pages_DataEntry_ServiceCompany_js"],{

/***/ "./resources/js/Admin/Pages/DataEntry/ServiceCompany.js":
/*!**************************************************************!*\
  !*** ./resources/js/Admin/Pages/DataEntry/ServiceCompany.js ***!
  \**************************************************************/
...
function ServiceComapny() {
  ...
  var HandleAdd = function HandleAdd(e) {
    e.preventDefault();
    setadding(true);
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.post('/companytype/store', {
      name: NewCat
    }).then(function (res) {
  ...
  var HandleDelete = function HandleDelete(e, itemId) {
    e.preventDefault();
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.delete("/companytype/delete/".concat(itemId)).then(function (res) {
      if (res.status == 200) {
  ...
  var sendUpdateRequest = function sendUpdateRequest(e) {
    e.preventDefault();
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.put("companytype/update/".concat(editId), {
      name: edit_cat
    }).then(function (res) {
      if (res.status == 200) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ServiceComapny);
