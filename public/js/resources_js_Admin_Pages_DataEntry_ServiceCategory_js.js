"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Admin_Pages_DataEntry_ServiceCategory_js"],{

/***/ "./resources/js/Admin/Pages/DataEntry/ServiceCategory.js":
/*!***************************************************************!*\
  !*** ./resources/js/Admin/Pages/DataEntry/ServiceCategory.js ***!
  \***************************************************************/
...
function ServiceCategory() {
  ...
  var HandleAdd = function HandleAdd(e) {
    e.preventDefault();
    setadding(true);
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.post('/service_category/store', {
      name: NewCat
    }).then(function (res) {
  ...
  var HandleDelete = function HandleDelete(e, itemId) {
    e.preventDefault();
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.delete("/service_category/delete/".concat(itemId)).then(function (res) {
      if (res.status == 200) {
  ...
  var sendUpdateRequest = function sendUpdateRequest(e) {
    e.preventDefault();
    _axios__WEBPACK_IMPORTED_MODULE_2__.AdminAxios.put("service_category/update/".concat(editId), {
      name: edit_cat
    }).then(function (res) {
      if (res.status == 200) {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("h5", {
              ...
              children: Categories.map(function (c, i) {
                return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("div", {
                  ...
                  children: editIndex === i ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("form", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ServiceCategory);
