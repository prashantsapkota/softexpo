                ...
                <div className="table-responsive">
                  <table className="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td className="py-1">
                          <img src="/assets/images/faces/face2.jpg" alt="user icon" />
                        </td>
                        <td> Messsy Adam </td>
                        <td>
                      ...
                      <tr>
                        <td className="py-1">
                          <img src="/assets/images/faces/face3.jpg" alt="user icon" />
                        </td>
                        <td> John Richards </td>
                        <td>
                      ...
                      <tr>
                        <td className="py-1">
                          <img src="/assets/images/faces/face4.jpg" alt="user icon" />
                        </td>
                        <td> Peter Meggik </td>
                        <td>
                      ...
                      <tr>
                        <td className="py-1">
                          <img src="/assets/images/faces/face5.jpg" alt="user icon" />
                        </td>
                        <td> Edward </td>
                        <td>
                      ...
                      <tr>
                        <td className="py-1">
                          <img src="/assets/images/faces/face6.jpg" alt="user icon" />
                        </td>
                        <td> John Doe </td>
                        <td>
                      ...
                      <tr>
                        <td className="py-1">
                          <img src="/assets/images/faces/face7.jpg" alt="user icon" />
                        </td>
                        <td> Henry Tom </td>
                        <td>
